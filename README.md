...
Antes de cada luta, os estados de cada exército (soldados vivos, saúde e poder) são mostrados na tela e é anunciado um confronto entre um soldado do bem e um soldado do mal.
